...
<section class="relative h-screen flex items-center justify-center text-center bg-cover bg-center pt-20"
  ...
  <div class="bg-blue-900 bg-opacity-50 p-6 rounded-md max-w-2xl">
    ...
    <a href="login.php" class="bg-white text-blue-600 font-bold px-6 py-2 rounded-full hover:bg-blue-100 transition">GET
      STARTED</a>
  </div>
</section>

<section id="about" class="bg-gray-100 pt-20">
  <section class="min-h-screen bg-gray-100 px-7 py-19">
    ...
    <p class="mb-4">
      <strong>Trackify</strong> is a powerful yet simple habit tracking web app built to help individuals create
      consistency and accountability in their daily routines. Whether you’re aiming to build better habits, break bad
      ones, or just visualize your progress, Trackify provides a clean, intuitive interface to help you stay on track.
    </p>
    <p class="mb-4">
      With features like weekly tracking, progress visualization, and easy habit editing, Trackify turns habit-building
      into a motivating and rewarding experience. It removes the clutter and focuses on what matters most: helping you
      build meaningful routines over time.
    </p>
    <p class="mb-4">
      The application is built using <strong>PHP</strong> for the backend and <strong>Tailwind CSS</strong> for a modern
      frontend look. It's fully responsive, lightweight, and privacy-friendly—your habits stay yours.
    </p>
    <p class="mb-4">
      Whether you want to wake up earlier, exercise daily, learn a new language, or even drink more water—Trackify is
      your perfect daily companion. It’s ideal for students, professionals, creators, or anyone looking to grow
      personally or professionally.
    </p>
    <p class="mb-6">
      <strong>Our vision:</strong> Make habit tracking more human, accessible, and visually fun—without the distractions
      of social feeds or ads.
    </p>
    ...
    <div class="my-6 p-4 bg-white border rounded shadow text-center">
      ...
      <div class="flex flex-col md:flex-row items-center justify-center gap-4">
        ...
        <div class="p-4  bg-green-100 rounded shadow w-40">💪 Action<br><small>For example, 10 mins meditation</small>
        </div>
        <!-- <span class="text-xl">➡️</span> -->
